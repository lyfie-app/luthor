    ...
    <>
      <div className="luthor-toolbar">
        ...
        <div className="luthor-toolbar-section">
          <button onClick={() => commands.toggleBold()} className={`luthor-toolbar-button ${activeStates.bold ? "active" : ""}`} title="Bold (Ctrl+B)"><Bold size={16} /></button>
          <button onClick={() => commands.toggleItalic()} className={`luthor-toolbar-button ${activeStates.italic ? "active" : ""}`} title="Italic (Ctrl+I)"><Italic size={16} /></button>
          <button onClick={() => commands.toggleUnderline()} className={`luthor-toolbar-button ${activeStates.underline ? "active" : ""}`} title="Underline (Ctrl+U)"><Underline size={16} /></button>
          <button onClick={() => commands.toggleStrikethrough()} className={`luthor-toolbar-button ${activeStates.strikethrough ? "active" : ""}`} title="Strikethrough"><Strikethrough size={16} /></button>
        ...
        {hasExtension("list") && (
          <div className="luthor-toolbar-section">
            ...
            <button onClick={() => commands.toggleOrderedList()} className={`luthor-toolbar-button ${activeStates.orderedList ? "active" : ""}`} title="Numbered List"><ListOrdered size={16} /></button>
            {(activeStates.unorderedList || activeStates.orderedList) && (
              <>
                <button onClick={() => commands.indentList()} className="luthor-toolbar-button" title="Indent List"><Indent size={14} /></button>
                <button onClick={() => commands.outdentList()} className="luthor-toolbar-button" title="Outdent List"><Outdent size={14} /></button>
              </>
            )}
          </div>
        )}
        ...
        {hasExtension("image") && (
          <div className="luthor-toolbar-section">
            ...
            {activeStates.imageSelected && (
              <Dropdown
                trigger={<button className="luthor-toolbar-button" title="Align Image"><AlignCenter size={16} /></button>}
              ...
              >
                ...
                <button className="luthor-dropdown-item" onClick={() => { handlers.setAlignment("center"); setShowAlignDropdown(false); }}><AlignCenter size={16} /> Align Center</button>
                ...
                <button className="luthor-dropdown-item" onClick={() => { handlers.setCaption(); setShowAlignDropdown(false); }}><Type size={16} /> Set Caption</button>
              </Dropdown>
            )}
        ...
        {hasExtension("history") && (
          <div className="luthor-toolbar-section">
            <button onClick={() => commands.undo()} disabled={!activeStates.canUndo} className="luthor-toolbar-button" title="Undo (Ctrl+Z)"><Undo size={16} /></button>
            <button onClick={() => commands.redo()} disabled={!activeStates.canRedo} className="luthor-toolbar-button" title="Redo (Ctrl+Y)"><Redo size={16} /></button>
          </div>
        )}
...
function HTMLSourceView({ htmlContent, onHtmlChange }: { htmlContent: string; onHtmlChange: (html: string) => void }) {
  return <textarea className="luthor-html-view" value={htmlContent} onChange={(e) => onHtmlChange(e.target.value)} placeholder="Enter HTML content..." spellCheck={false} />;
}
...
function MarkdownSourceView({ markdownContent, onMarkdownChange }: { markdownContent: string; onMarkdownChange: (markdown: string) => void }) {
  return <textarea className="luthor-html-view" value={markdownContent} onChange={(e) => onMarkdownChange(e.target.value)} placeholder="Enter Markdown content..." spellCheck={false} />;
}
