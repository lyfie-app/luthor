...
That's why I built Luthor — a clean, type-safe abstraction on top of Meta's Lexical that makes rich text editing approachable and enjoyable. It's designed to eliminate the frustration and let you focus on building great user experiences.
...
Ready to try it? Pick your package manager above and let's build something amazing together! 🚀`);
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold">
            Luthor — a type-safe rich text editor framework
          </h1>
        </div>
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Build editors fast. Luthor is headless and TypeScript-first, powered
      ...
      {/* What makes Luthor different */}
      <div className="space-y-8">
        <div className="text-center space-y-4">
          <h2 className="text-3xl font-bold">What makes Luthor different</h2>
      ...
      <div className="space-y-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Install Luthor and start building in minutes.
          </p>
        </div>
      ...
      <div className="bg-muted/50 rounded-lg p-6 space-y-4">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Luthor is free, open-source software built by developers, for
            ...
            Every contribution helps maintain and improve Luthor for everyone.
          </p>
