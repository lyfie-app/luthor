    ...
    <div className="max-w-4xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold">Contributing to Luthor</h1>
          <p className="text-xl text-muted-foreground mt-2">
            Help us build the future of rich text editing
          </p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Luthor is an open-source project built with modern web technologies.
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Luthor is a monorepo built with modern tools. Here's how to get
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Luthor is hosted on GitHub. Clone the repository to get started:
              </p>
              <SimpleCodeBlock
                title="Clone the Luthor repository"
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed mb-4">
                Luthor uses pnpm for package management. Install all
                dependencies:
              </p>
              <SimpleCodeBlock
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Luthor is organized as a monorepo with clear separation of concerns.
        </p>

        <Card>
          <CardContent>
            <SimpleCodeBlock
              title="Luthor Monorepo Structure"
