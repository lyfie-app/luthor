...
>
  <MyEditor />
    ...
    description: "Apply your custom theme to the Luthor editor",
...
const customOverrides: Partial<LuthorTheme> = {
  text: {
...
<Provider extensions={extensions} config={{ theme: finalTheme }}>
  ...
  },
  {
    ...
    code: `/* CSS using custom properties */
:root {
  --editor-bg: #ffffff;
  --editor-text: #1f2937;
...
/* Theme powered by CSS variables */
  const responsiveTheme: LuthorTheme = {
  ...
  },
  {
    ...
    code: `const themeWithExtensions: LuthorTheme = {
  // Shared properties
...
<Provider extensions={extensions} config={{ theme: luthorTheme }}>
  <MyEditor />
</Provider>`,
    language: "tsx",
    title: "Luthor Theme (After)",
    description: "Enhanced Luthor theme with additional properties",
...
function MultiEditorApp() {
  return (
    <div className="space-y-8">
      {/* Minimal editor for short comments */}
      <div>
