...
export function GetStartedPageClient() {
  ...
  // Inject content once the editor is ready
...
This is your first Luthor editor. Try the toolbar buttons above to format text, create lists, and more.

**Bold text**, *italic text*, and \`inline code\` are just the beginning. Luthor gives you complete control over your rich text editing experience.
    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold">Get Started with Luthor</h1>
          <p className="text-xl text-muted-foreground mt-2">
            Build your first rich text editor in minutes
          </p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Follow this step-by-step guide to create powerful, type-safe rich text
          editors with Luthor. We'll cover installation, basic setup, theming,
          and extensions.
        </p>
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <Badge variant="secondary" className="px-3 py-1">
            <Download className="h-3 w-3 mr-1" />5 Minute Setup
          </Badge>
          <Badge variant="secondary" className="px-3 py-1">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center space-y-4 mb-8">
          <h2 className="text-3xl font-bold">Try Luthor Live</h2>
          <p className="text-lg text-muted-foreground">
            Experience the power of Luthor with this interactive editor. Use the
            toolbar to format text, create lists, and explore features.
          </p>
        </div>
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-primary/5 to-primary/10">
        <CardHeader>
          ...
          <CardDescription>Install Luthor and its dependencies</CardDescription>
        </CardHeader>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-800 dark:text-green-200">
                  That's it! Luthor is now installed and ready to use. Let's
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20">
        <CardHeader>
          ...
          <CardDescription>
            Luthor offers two ways to create rich text editors
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="flex flex-col md:grid md:grid-cols-2 gap-4 md:gap-6">
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Use RichText as a Luthor extension with createEditorSystem for
                full type safety and modularity. RichTextExtension is built on
                top of Lexical's RichTextPlugin to make using the original tool
                easier.
              </p>
              <SimpleCodeBlock
                html={getHighlightedCode("richtext-with-extensions") || ""}
                raw={getRawCode("richtext-with-extensions") || ""}
                title="RichText as Luthor Extension"
                height="h-48"
              />
            </div>
            ...
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Use createEditorSystem with manual RichTextPlugin setup for
                maximum control. You can also use RichTextPlugin from Lexical
                directly, but Luthor's RichTextExtension is built on top of it
                to make using the original Lexical tool easier.
              </p>
              <SimpleCodeBlock
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                  <li>
                    <strong>RichText as Extension:</strong> Use
                    createEditorSystem with RichTextExtension for full type
                    safety and modularity. Perfect for complex editors.
                  </li>
                  <li>
                    <strong>Manual RichText Setup:</strong> Use
                    createEditorSystem with manual RichTextPlugin setup for
                    maximum control. Great for advanced customization.
                  </li>
                </ul>
              </div>
            </div>
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-950/20 dark:to-indigo-950/20">
        <CardHeader>
          ...
          <CardDescription>
            Understand the core concepts: createEditorSystem, extensions, and
            RichText
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="prose prose-sm max-w-none">
            <p>
              Luthor is built around three core concepts that work together to
          ...
          <div className="flex flex-col md:grid md:grid-cols-3 gap-4">
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground">
                A factory function that creates a typed editor system based on
                your extensions. Provides full type safety.
              </p>
            </div>
            ...
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground">
                Modular pieces that add functionality like bold, italic, lists,
                images, etc. Mix and match as needed.
              </p>
            </div>
            ...
            <div className="bg-background/80 rounded-lg p-4 border">
              ...
              <p className="text-sm text-muted-foreground">
                The core editor component that renders the editable content. Can
                be used standalone or with extensions.
              </p>
            </div>
          </div>
          ...
          <div className="bg-muted/50 rounded-lg p-4">
            <h4 className="font-semibold mb-2 flex items-center gap-2">
              ...
              Two Ways to Use Luthor
            </h4>
            <div className="flex flex-col md:grid md:grid-cols-2 gap-4 mt-3">
              <div className="text-sm">
                <strong className="text-primary">Extension System:</strong> Use{" "}
                <code>createEditorSystem</code> with RichTextExtension for full
                type safety and modularity. Perfect for complex editors.
              </div>
              <div className="text-sm">
                <strong className="text-primary">Manual Setup:</strong> Use{" "}
                <code>createEditorSystem</code> with manual RichTextPlugin setup
                for maximum control. Great for advanced customization.
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50/50 to-pink-50/50 dark:from-purple-950/20 dark:to-pink-950/20">
        ...
        <CardContent className="space-y-6">
          <div className="bg-background/80 rounded-lg p-4 border">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Use Luthor's theme system to apply classnames to different editor
              elements for complete styling control.
            </p>
            <SimpleCodeBlock
              html={getHighlightedCode("theming-with-luthor") || ""}
              raw={getRawCode("theming-with-luthor") || ""}
              title="Luthor Theme System"
              height="h-64"
            />
          </div>
      ...
      <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-950/20 dark:to-emerald-950/20">
        <CardHeader>
          ...
          <CardDescription>
            Add powerful features with Luthor's extension system
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="bg-background/80 rounded-lg p-4 border">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Luthor comes with 25+ extensions for common features. Here's how
              to use them:
            </p>
            <SimpleCodeBlock
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    <strong>Structure:</strong> Headings, lists, quotes,
                    horizontal rules
                  </div>
                  <div>
                    <strong>Rich Content:</strong> Tables, images, links, code
                    blocks
                  </div>
                  <div>
                    <strong>Advanced:</strong> History, command palette, context
                    menus
                  </div>
                </div>
              </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  You've learned the fundamentals of Luthor. Now you can:
                </p>
