    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 py-8">
        <div className="text-center">
          ...
          <p className="text-xl text-muted-foreground mt-2">
            Get Luthor running in your project
          </p>
        </div>
        <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
          Follow our step-by-step guide to install Luthor and its peer
      ...
      <div className="space-y-6">
        <h2 className="text-3xl font-bold text-center">
          Understanding Luthor's Architecture
        </h2>
        <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-center leading-relaxed">
          Luthor is built on Meta's Lexical framework. Here's why this matters
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                Luthor doesn't bundle Lexical — instead, it declares it as a
          ...
          <Card className="border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                You'll install both Luthor and its Lexical dependencies
              ...
              <div className="bg-muted/50 rounded-lg p-4">
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  version that matches your Luthor version.
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Install Luthor first, then its Lexical peer dependencies.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <CardDescription className="text-base leading-relaxed mb-4">
                Install the Lexical packages that power Luthor's functionality.
      ...
      <div className="space-y-6">
        <div className="text-center space-y-3">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            See Luthor in action with this basic example.
          </p>
        </div>

        <DynamicCodeExample
          codes={["examples/BasicEditorExample.tsx"]}
          title="Your First Luthor Editor"
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 md:gap-6 gap-4">
          ...
          <Card className="border-blue-200 dark:border-blue-800">
            ...
            <CardContent>
              <CardDescription className="text-base leading-relaxed">
                Make sure your TypeScript version is compatible. Luthor requires
      ...
      <Card className="bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20">
        <CardContent className="text-center py-12 space-y-6">
          <div className="space-y-3">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Now that Luthor is installed, let's start building amazing
              editors!
            </p>
          </div>
