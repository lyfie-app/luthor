...
export default function DefaultTemplatePageClient() {
  ...
  const handleEditorReady = React.useCallback((methods: DefaultTemplateRef) => {
    ...
    methods.injectMarkdown(`# Welcome to Luthor DefaultTemplate
...
> **Tip**: You can paste images directly into the editor or use the image button in the toolbar.`);
  ...
  const handleExportHTML = () => {
    ...
    if (html) {
      ...
      const a = document.createElement("a");
      a.href = url;
      a.download = "luthor-content.html";
      a.click();
      URL.revokeObjectURL(url);
    }
  };
      ...
      <div className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground leading-relaxed">
                Built on Luthor's extension system - easily add custom features.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Copy these files from the Luthor repository to your project:
            </CardDescription>
          </CardHeader>
