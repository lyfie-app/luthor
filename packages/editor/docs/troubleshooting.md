...
```tsx
import { Provider } from "@lyfie/luthor";
...
```tsx
import { HistoryExtension, TextFormatExtension } from "@lyfie/luthor";
...
```bash
npm install @lyfie/luthor@latest
```

2. **Import Types Correctly**:

```tsx
import type { EditorConfig, Extension } from "@lyfie/luthor";
```
...
```tsx
// Good
import { Provider, HistoryExtension } from "@lyfie/luthor";
