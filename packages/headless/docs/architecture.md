# Luthor Editor Architecture

## Overview

Luthor is a headless, extensible rich text editor built on top of Lexical. It provides a type-safe, plugin-based architecture for building modern editing experiences.

## Core Concepts

### Extensions

Extensions are the fundamental building blocks of Luthor. Each extension provides specific functionality:
...
Luthor uses advanced TypeScript features for type safety:
...
import { boldExtension, italicExtension } from "@lyfie/luthor-headless/extensions";
