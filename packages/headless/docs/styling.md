# Luthor Styling Guide

## Overview

Luthor is **headless by design** - you control all the styling! There are several ways to customize the editor's appearance to match your application's design system.

## Theme System

Luthor uses a structured theme system that maps CSS classes to different editor elements:
...
- Ensure your CSS is loaded after Luthor's styles
